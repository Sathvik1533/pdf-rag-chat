...
class RAGPipeline:
    ...
    def retrieve(
        ...
        # Enrich when the user is asking for a whole-document overview — covers ALL
        # suggested questions generated by updateSmartStarterChips() in app.js
        enriched_query = query_text
        if session.current_filename:
            q_lower = query_text.lower().strip()
            explicit_overview_phrases = [
                # Generic document overview (default file types: pdf, docx, md, txt)
